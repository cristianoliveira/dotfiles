...
Treat the preference bundle as application-owned exported configuration. Darwin system settings belong in [nix/osx](../AGENTS.md); executable helper behavior belongs in [bin](../../../bin/AGENTS.md).

# Connections

- [macOS modules](../AGENTS.md): provides the platform-specific home for this adapter.
