...
## TOOLS AVAILABLE:
 - `ripgrep` for granular search and grepping, use it instead of `grep` or `ag`
 - `zk` for organizing and navigating your knowledge base, indexing and tagging.
 - `tree` for visualizing the directory structure of your knowledge base.
 - `jq` for parsing and manipulating JSON data.
 - `playwright_*` for navigating and interacting with web pages.
