...
COMMANDS_SH=("$HOME/.dotfiles/ai/bin/aimeta" "autoland")

echo "=== Command Discovery Cache Integration Test ==="
echo "Script: aimeta autoland"
echo
